...
type Organization struct {
	...
	// The primary key of the organization in 1080.
	...
	// The list of categories of this organization (used by FI's to as part of their processing rules).
...
func (x *Organization) GetCreated() *timestamp.Timestamp {
	if x != nil {
		return x.Created
	}
	return nil
...
func (x *Organization) GetUpdated() *timestamp.Timestamp {
	if x != nil {
		return x.Updated
	}
	return nil
...
var file_common_v1_organization_proto_rawDesc = []byte{
	...
	0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x42, 0x54, 0x0a, 0x17, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72,
	0x6b, 0x2e, 0x74, 0x65, 0x6e, 0x38, 0x30, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x76,
