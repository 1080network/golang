...
func (IntervalType) Descriptor() protoreflect.EnumDescriptor {
	return file_mica_partner_transaction_v1_transaction_proto_enumTypes[0].Descriptor()
}

func (IntervalType) Type() protoreflect.EnumType {
	return &file_mica_partner_transaction_v1_transaction_proto_enumTypes[0]
}
...
func (IntervalType) EnumDescriptor() ([]byte, []int) {
	return file_mica_partner_transaction_v1_transaction_proto_rawDescGZIP(), []int{0}
}
...
func (TransactionType) Descriptor() protoreflect.EnumDescriptor {
	return file_mica_partner_transaction_v1_transaction_proto_enumTypes[1].Descriptor()
}

func (TransactionType) Type() protoreflect.EnumType {
	return &file_mica_partner_transaction_v1_transaction_proto_enumTypes[1]
}
...
func (TransactionType) EnumDescriptor() ([]byte, []int) {
	return file_mica_partner_transaction_v1_transaction_proto_rawDescGZIP(), []int{1}
}
...
func (SearchTransactionDataResponse_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_mica_partner_transaction_v1_transaction_proto_enumTypes[2].Descriptor()
}

func (SearchTransactionDataResponse_Status) Type() protoreflect.EnumType {
	return &file_mica_partner_transaction_v1_transaction_proto_enumTypes[2]
}
...
func (SearchTransactionDataResponse_Status) EnumDescriptor() ([]byte, []int) {
	return file_mica_partner_transaction_v1_transaction_proto_rawDescGZIP(), []int{2, 0}
}
...
func (SearchTransactionGeographyDataResponse_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_mica_partner_transaction_v1_transaction_proto_enumTypes[3].Descriptor()
}

func (SearchTransactionGeographyDataResponse_Status) Type() protoreflect.EnumType {
	return &file_mica_partner_transaction_v1_transaction_proto_enumTypes[3]
}
...
func (SearchTransactionGeographyDataResponse_Status) EnumDescriptor() ([]byte, []int) {
	return file_mica_partner_transaction_v1_transaction_proto_rawDescGZIP(), []int{5, 0}
}
...
func (SearchTransactionServiceProviderDataResponse_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_mica_partner_transaction_v1_transaction_proto_enumTypes[4].Descriptor()
}

func (SearchTransactionServiceProviderDataResponse_Status) Type() protoreflect.EnumType {
	return &file_mica_partner_transaction_v1_transaction_proto_enumTypes[4]
}
...
func (SearchTransactionServiceProviderDataResponse_Status) EnumDescriptor() ([]byte, []int) {
	return file_mica_partner_transaction_v1_transaction_proto_rawDescGZIP(), []int{8, 0}
}
...
type SearchTransactionDataRequest struct {
	...
	// optional
	IntervalType IntervalType `protobuf:"varint,3,opt,name=interval_type,json=intervalType,proto3,enum=mica.partner.transaction.v1.IntervalType" json:"interval_type,omitempty"`
	// the number of records to return
	// optional
	TopN int64 `protobuf:"varint,4,opt,name=top_n,json=topN,proto3" json:"top_n,omitempty"`
	// optional
	TransactionType TransactionType `protobuf:"varint,5,opt,name=transaction_type,json=transactionType,proto3,enum=mica.partner.transaction.v1.TransactionType" json:"transaction_type,omitempty"`
	// optional
...
func (x *SearchTransactionDataRequest) Reset() {
	*x = SearchTransactionDataRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mica_partner_transaction_v1_transaction_proto_msgTypes[0]
...
func (x *CountAmountItem) Reset() {
	*x = CountAmountItem{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mica_partner_transaction_v1_transaction_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
type SearchTransactionDataResponse struct {
	...
	Status           SearchTransactionDataResponse_Status `protobuf:"varint,1,opt,name=status,proto3,enum=mica.partner.transaction.v1.SearchTransactionDataResponse_Status" json:"status,omitempty"`
...
func (x *SearchTransactionDataResponse) Reset() {
	*x = SearchTransactionDataResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mica_partner_transaction_v1_transaction_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SearchTransactionDataResponse) Descriptor() ([]byte, []int) {
	return file_mica_partner_transaction_v1_transaction_proto_rawDescGZIP(), []int{2}
}
...
func (x *SearchTransactionGeographyDataRequest) Reset() {
	*x = SearchTransactionGeographyDataRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mica_partner_transaction_v1_transaction_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SearchTransactionGeographyDataRequest) Descriptor() ([]byte, []int) {
	return file_mica_partner_transaction_v1_transaction_proto_rawDescGZIP(), []int{3}
}
...
func (x *SearchTransactionGeographyDataItem) Reset() {
	*x = SearchTransactionGeographyDataItem{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mica_partner_transaction_v1_transaction_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SearchTransactionGeographyDataItem) Descriptor() ([]byte, []int) {
	return file_mica_partner_transaction_v1_transaction_proto_rawDescGZIP(), []int{4}
}
...
type SearchTransactionGeographyDataResponse struct {
	...
	Status SearchTransactionGeographyDataResponse_Status `protobuf:"varint,1,opt,name=status,proto3,enum=mica.partner.transaction.v1.SearchTransactionGeographyDataResponse_Status" json:"status,omitempty"`
	Error  *v1.Error                                     `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`
	Cid    string                                        `protobuf:"bytes,3,opt,name=cid,proto3" json:"cid,omitempty"`
...
func (x *SearchTransactionGeographyDataResponse) Reset() {
	*x = SearchTransactionGeographyDataResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mica_partner_transaction_v1_transaction_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SearchTransactionGeographyDataResponse) Descriptor() ([]byte, []int) {
	return file_mica_partner_transaction_v1_transaction_proto_rawDescGZIP(), []int{5}
}
...
func (x *SearchTransactionServiceProviderDataRequest) Reset() {
	*x = SearchTransactionServiceProviderDataRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mica_partner_transaction_v1_transaction_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SearchTransactionServiceProviderDataRequest) Descriptor() ([]byte, []int) {
	return file_mica_partner_transaction_v1_transaction_proto_rawDescGZIP(), []int{6}
}
...
func (x *SearchTransactionServiceProviderDataItem) Reset() {
	*x = SearchTransactionServiceProviderDataItem{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mica_partner_transaction_v1_transaction_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SearchTransactionServiceProviderDataItem) Descriptor() ([]byte, []int) {
	return file_mica_partner_transaction_v1_transaction_proto_rawDescGZIP(), []int{7}
}
...
type SearchTransactionServiceProviderDataResponse struct {
	...
	Status SearchTransactionServiceProviderDataResponse_Status `protobuf:"varint,1,opt,name=status,proto3,enum=mica.partner.transaction.v1.SearchTransactionServiceProviderDataResponse_Status" json:"status,omitempty"`
	Error  *v1.Error                                           `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`
	Cid    string                                              `protobuf:"bytes,3,opt,name=cid,proto3" json:"cid,omitempty"`
...
func (x *SearchTransactionServiceProviderDataResponse) Reset() {
	*x = SearchTransactionServiceProviderDataResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mica_partner_transaction_v1_transaction_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SearchTransactionServiceProviderDataResponse) Descriptor() ([]byte, []int) {
	return file_mica_partner_transaction_v1_transaction_proto_rawDescGZIP(), []int{8}
}
...
var File_mica_partner_transaction_v1_transaction_proto protoreflect.FileDescriptor

var file_mica_partner_transaction_v1_transaction_proto_rawDesc = []byte{
	0x0a, 0x2d, 0x6d, 0x69, 0x63, 0x61, 0x2f, 0x70, 0x61, 0x72, 0x74, 0x6e, 0x65, 0x72, 0x2f, 0x74,
	...
	0x1b, 0x6d, 0x69, 0x63, 0x61, 0x2e, 0x70, 0x61, 0x72, 0x74, 0x6e, 0x65, 0x72, 0x2e, 0x74, 0x72,
	...
	0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xad, 0x04, 0x0a,
	...
	0x61, 0x6d, 0x70, 0x52, 0x06, 0x64, 0x61, 0x74, 0x65, 0x54, 0x6f, 0x12, 0x4e, 0x0a, 0x0d, 0x69,
	0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x29, 0x2e, 0x6d, 0x69, 0x63, 0x61, 0x2e, 0x70, 0x61, 0x72, 0x74, 0x6e, 0x65,
	...
	0x12, 0x57, 0x0a, 0x10, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f,
	0x74, 0x79, 0x70, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2c, 0x2e, 0x6d, 0x69, 0x63,
	...
	0x75, 0x6e, 0x74, 0x22, 0xe3, 0x02, 0x0a, 0x1d, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x54, 0x72,
	0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x59, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x41, 0x2e, 0x6d, 0x69, 0x63, 0x61, 0x2e, 0x70, 0x61, 0x72,
	...
	0x72, 0x6f, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x63, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x03, 0x63, 0x69, 0x64, 0x12, 0x5a, 0x0a, 0x12, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x61,
	0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x2c, 0x2e, 0x6d, 0x69, 0x63, 0x61, 0x2e, 0x70, 0x61, 0x72, 0x74, 0x6e, 0x65, 0x72,
	...
	0x53, 0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x02, 0x22, 0x9a, 0x05, 0x0a, 0x25, 0x53, 0x65,
	...
	,
	...
	0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xba, 0x01, 0x0a, 0x22, 0x53, 0x65, 0x61, 0x72, 0x63,
	...
	,
	...
	0x28, 0x09, 0x52, 0x03, 0x63, 0x69, 0x64, 0x12, 0x55, 0x0a, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73,
	0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x3f, 0x2e, 0x6d, 0x69, 0x63, 0x61, 0x2e, 0x70, 0x61,
	...
	0x52, 0x52, 0x4f, 0x52, 0x10, 0x02, 0x22, 0xbc, 0x04, 0x0a, 0x2b, 0x53, 0x65, 0x61, 0x72, 0x63,
	...
	0x74, 0x65, 0x54, 0x6f, 0x12, 0x4e, 0x0a, 0x0d, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c,
	...
	0x01, 0x28, 0x03, 0x52, 0x04, 0x74, 0x6f, 0x70, 0x4e, 0x12, 0x57, 0x0a, 0x10, 0x74, 0x72, 0x61,
	...
	0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xf5, 0x01, 0x0a, 0x28, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68,
	0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x49, 0x74,
	0x65, 0x6d, 0x12, 0x3b, 0x0a, 0x14, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x70, 0x72,
	...
	,
	...
	0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x63, 0x69, 0x64, 0x12, 0x5b, 0x0a,
	0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x45, 0x2e, 0x6d,
	...
	0x74, 0x65, 0x6d, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x46, 0x0a, 0x06, 0x53, 0x74,
	...
	,
	...
	,
}

var (
	file_mica_partner_transaction_v1_transaction_proto_rawDescOnce sync.Once
	file_mica_partner_transaction_v1_transaction_proto_rawDescData = file_mica_partner_transaction_v1_transaction_proto_rawDesc
)

func file_mica_partner_transaction_v1_transaction_proto_rawDescGZIP() []byte {
	file_mica_partner_transaction_v1_transaction_proto_rawDescOnce.Do(func() {
		file_mica_partner_transaction_v1_transaction_proto_rawDescData = protoimpl.X.CompressGZIP(file_mica_partner_transaction_v1_transaction_proto_rawDescData)
	})
	return file_mica_partner_transaction_v1_transaction_proto_rawDescData
}

var file_mica_partner_transaction_v1_transaction_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_mica_partner_transaction_v1_transaction_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_mica_partner_transaction_v1_transaction_proto_goTypes = []interface{}{
	(IntervalType)(0),                                        // 0: mica.partner.transaction.v1.IntervalType
	(TransactionType)(0),                                     // 1: mica.partner.transaction.v1.TransactionType
	(SearchTransactionDataResponse_Status)(0),                // 2: mica.partner.transaction.v1.SearchTransactionDataResponse.Status
	(SearchTransactionGeographyDataResponse_Status)(0),       // 3: mica.partner.transaction.v1.SearchTransactionGeographyDataResponse.Status
	(SearchTransactionServiceProviderDataResponse_Status)(0), // 4: mica.partner.transaction.v1.SearchTransactionServiceProviderDataResponse.Status
	(*SearchTransactionDataRequest)(nil),                     // 5: mica.partner.transaction.v1.SearchTransactionDataRequest
	(*CountAmountItem)(nil),                                  // 6: mica.partner.transaction.v1.CountAmountItem
	(*SearchTransactionDataResponse)(nil),                    // 7: mica.partner.transaction.v1.SearchTransactionDataResponse
	(*SearchTransactionGeographyDataRequest)(nil),            // 8: mica.partner.transaction.v1.SearchTransactionGeographyDataRequest
	(*SearchTransactionGeographyDataItem)(nil),               // 9: mica.partner.transaction.v1.SearchTransactionGeographyDataItem
	(*SearchTransactionGeographyDataResponse)(nil),           // 10: mica.partner.transaction.v1.SearchTransactionGeographyDataResponse
	(*SearchTransactionServiceProviderDataRequest)(nil),      // 11: mica.partner.transaction.v1.SearchTransactionServiceProviderDataRequest
	(*SearchTransactionServiceProviderDataItem)(nil),         // 12: mica.partner.transaction.v1.SearchTransactionServiceProviderDataItem
	(*SearchTransactionServiceProviderDataResponse)(nil),     // 13: mica.partner.transaction.v1.SearchTransactionServiceProviderDataResponse
...
var file_mica_partner_transaction_v1_transaction_proto_depIdxs = []int32{
	14, // 0: mica.partner.transaction.v1.SearchTransactionDataRequest.date_from:type_name -> google.protobuf.Timestamp
	14, // 1: mica.partner.transaction.v1.SearchTransactionDataRequest.date_to:type_name -> google.protobuf.Timestamp
	0,  // 2: mica.partner.transaction.v1.SearchTransactionDataRequest.interval_type:type_name -> mica.partner.transaction.v1.IntervalType
	1,  // 3: mica.partner.transaction.v1.SearchTransactionDataRequest.transaction_type:type_name -> mica.partner.transaction.v1.TransactionType
	15, // 4: mica.partner.transaction.v1.SearchTransactionDataRequest.currency:type_name -> micashared.common.enums.currency.v1.Currency
	14, // 5: mica.partner.transaction.v1.CountAmountItem.date:type_name -> google.protobuf.Timestamp
	15, // 6: mica.partner.transaction.v1.CountAmountItem.currency:type_name -> micashared.common.enums.currency.v1.Currency
	2,  // 7: mica.partner.transaction.v1.SearchTransactionDataResponse.status:type_name -> mica.partner.transaction.v1.SearchTransactionDataResponse.Status
	16, // 8: mica.partner.transaction.v1.SearchTransactionDataResponse.error:type_name -> micashared.common.v1.Error
	6,  // 9: mica.partner.transaction.v1.SearchTransactionDataResponse.count_amount_items:type_name -> mica.partner.transaction.v1.CountAmountItem
	14, // 10: mica.partner.transaction.v1.SearchTransactionGeographyDataRequest.date_from:type_name -> google.protobuf.Timestamp
	14, // 11: mica.partner.transaction.v1.SearchTransactionGeographyDataRequest.date_to:type_name -> google.protobuf.Timestamp
	0,  // 12: mica.partner.transaction.v1.SearchTransactionGeographyDataRequest.interval_type:type_name -> mica.partner.transaction.v1.IntervalType
	1,  // 13: mica.partner.transaction.v1.SearchTransactionGeographyDataRequest.transaction_type:type_name -> mica.partner.transaction.v1.TransactionType
	15, // 14: mica.partner.transaction.v1.SearchTransactionGeographyDataRequest.currency:type_name -> micashared.common.enums.currency.v1.Currency
	17, // 15: mica.partner.transaction.v1.SearchTransactionGeographyDataRequest.region:type_name -> micashared.common.enums.region.v1.Region
	6,  // 16: mica.partner.transaction.v1.SearchTransactionGeographyDataItem.count_amount_items:type_name -> mica.partner.transaction.v1.CountAmountItem
	3,  // 17: mica.partner.transaction.v1.SearchTransactionGeographyDataResponse.status:type_name -> mica.partner.transaction.v1.SearchTransactionGeographyDataResponse.Status
	16, // 18: mica.partner.transaction.v1.SearchTransactionGeographyDataResponse.error:type_name -> micashared.common.v1.Error
	9,  // 19: mica.partner.transaction.v1.SearchTransactionGeographyDataResponse.items:type_name -> mica.partner.transaction.v1.SearchTransactionGeographyDataItem
	14, // 20: mica.partner.transaction.v1.SearchTransactionServiceProviderDataRequest.date_from:type_name -> google.protobuf.Timestamp
	14, // 21: mica.partner.transaction.v1.SearchTransactionServiceProviderDataRequest.date_to:type_name -> google.protobuf.Timestamp
	0,  // 22: mica.partner.transaction.v1.SearchTransactionServiceProviderDataRequest.interval_type:type_name -> mica.partner.transaction.v1.IntervalType
	1,  // 23: mica.partner.transaction.v1.SearchTransactionServiceProviderDataRequest.transaction_type:type_name -> mica.partner.transaction.v1.TransactionType
	15, // 24: mica.partner.transaction.v1.SearchTransactionServiceProviderDataRequest.currency:type_name -> micashared.common.enums.currency.v1.Currency
	6,  // 25: mica.partner.transaction.v1.SearchTransactionServiceProviderDataItem.count_amount_item:type_name -> mica.partner.transaction.v1.CountAmountItem
	4,  // 26: mica.partner.transaction.v1.SearchTransactionServiceProviderDataResponse.status:type_name -> mica.partner.transaction.v1.SearchTransactionServiceProviderDataResponse.Status
	16, // 27: mica.partner.transaction.v1.SearchTransactionServiceProviderDataResponse.error:type_name -> micashared.common.v1.Error
	12, // 28: mica.partner.transaction.v1.SearchTransactionServiceProviderDataResponse.items:type_name -> mica.partner.transaction.v1.SearchTransactionServiceProviderDataItem
...
func init() { file_mica_partner_transaction_v1_transaction_proto_init() }
func file_mica_partner_transaction_v1_transaction_proto_init() {
	if File_mica_partner_transaction_v1_transaction_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_mica_partner_transaction_v1_transaction_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mica_partner_transaction_v1_transaction_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mica_partner_transaction_v1_transaction_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mica_partner_transaction_v1_transaction_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mica_partner_transaction_v1_transaction_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mica_partner_transaction_v1_transaction_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mica_partner_transaction_v1_transaction_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mica_partner_transaction_v1_transaction_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mica_partner_transaction_v1_transaction_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_mica_partner_transaction_v1_transaction_proto_rawDesc,
			NumEnums:      5,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mica_partner_transaction_v1_transaction_proto_goTypes,
		DependencyIndexes: file_mica_partner_transaction_v1_transaction_proto_depIdxs,
		EnumInfos:         file_mica_partner_transaction_v1_transaction_proto_enumTypes,
		MessageInfos:      file_mica_partner_transaction_v1_transaction_proto_msgTypes,
	}.Build()
	File_mica_partner_transaction_v1_transaction_proto = out.File
	file_mica_partner_transaction_v1_transaction_proto_rawDesc = nil
	file_mica_partner_transaction_v1_transaction_proto_goTypes = nil
	file_mica_partner_transaction_v1_transaction_proto_depIdxs = nil
}
