...
func (x *SearchTransactionServiceProviderDataRequest) GetDateFrom() *timestamp.Timestamp {
	if x != nil {
		return x.DateFrom
	}
	return nil
...
func (x *SearchTransactionServiceProviderDataRequest) GetDateTo() *timestamp.Timestamp {
	if x != nil {
		return x.DateTo
	}
	return nil
