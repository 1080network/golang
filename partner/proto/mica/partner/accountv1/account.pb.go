...
var file_mica_partner_account_v1_account_proto_rawDesc = []byte{
	...
	0x52, 0x5f, 0x4e, 0x4f, 0x54, 0x5f, 0x41, 0x4c, 0x4c, 0x4f, 0x57, 0x45, 0x44, 0x10, 0x03, 0x42,
	0x49, 0x0a, 0x1a, 0x69, 0x6f, 0x2e, 0x6d, 0x69, 0x63, 0x61, 0x2e, 0x70, 0x61, 0x72, 0x74, 0x6e,
	0x65, 0x72, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x76, 0x31, 0x42, 0x0c, 0x41,
	0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x5a, 0x16, 0x6d, 0x69, 0x63,
	0x61, 0x2f, 0x70, 0x61, 0x72, 0x74, 0x6e, 0x65, 0x72, 0x2f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e,
...
var file_mica_partner_account_v1_account_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_mica_partner_account_v1_account_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_mica_partner_account_v1_account_proto_goTypes = []interface{}{
	...
	(*SearchABAAccountRequest)(nil),      // 2: mica.partner.account.v1.SearchABAAccountRequest
	(*SearchABAAccountResponse)(nil),     // 3: mica.partner.account.v1.SearchABAAccountResponse
	(*CreateABAAccountRequest)(nil),      // 4: mica.partner.account.v1.CreateABAAccountRequest
	(*CreateABAAccountResponse)(nil),     // 5: mica.partner.account.v1.CreateABAAccountResponse
	(*v1.Error)(nil),                     // 6: micashared.common.v1.Error
	(*v1.ABAAccountEntry)(nil),           // 7: micashared.common.v1.ABAAccountEntry
	(*v1.ABAAccountNumber)(nil),          // 8: micashared.common.v1.ABAAccountNumber
}
var file_mica_partner_account_v1_account_proto_depIdxs = []int32{
	...
	6, // 1: mica.partner.account.v1.SearchABAAccountResponse.error:type_name -> micashared.common.v1.Error
	7, // 2: mica.partner.account.v1.SearchABAAccountResponse.aba_accounts:type_name -> micashared.common.v1.ABAAccountEntry
	8, // 3: mica.partner.account.v1.CreateABAAccountRequest.account:type_name -> micashared.common.v1.ABAAccountNumber
	...
	6, // 5: mica.partner.account.v1.CreateABAAccountResponse.error:type_name -> micashared.common.v1.Error
