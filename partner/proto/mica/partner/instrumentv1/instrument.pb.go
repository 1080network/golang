...
type ProvisionUUEKFromLinkRequest struct {
	...
	//
	//	*ProvisionUUEKFromLinkRequest_ObtainValue
	//	*ProvisionUUEKFromLinkRequest_ReturnValue
	//	*ProvisionUUEKFromLinkRequest_HoldValue
	//	*ProvisionUUEKFromLinkRequest_CreateRecurringPayment
	Intent isProvisionUUEKFromLinkRequest_Intent `protobuf_oneof:"intent"`
}
...
func (m *ProvisionUUEKFromLinkRequest) GetIntent() isProvisionUUEKFromLinkRequest_Intent {
	if m != nil {
		return m.Intent
	}
	return nil
...
func (x *ProvisionUUEKFromLinkRequest) GetObtainValue() *ProvisionUUEKFromLinkRequest_ObtainValueIntent {
	if x, ok := x.GetIntent().(*ProvisionUUEKFromLinkRequest_ObtainValue); ok {
		return x.ObtainValue
	}
	return nil
}

func (x *ProvisionUUEKFromLinkRequest) GetReturnValue() *ProvisionUUEKFromLinkRequest_ReturnValueIntent {
	if x, ok := x.GetIntent().(*ProvisionUUEKFromLinkRequest_ReturnValue); ok {
		return x.ReturnValue
	}
	return nil
}

func (x *ProvisionUUEKFromLinkRequest) GetHoldValue() *ProvisionUUEKFromLinkRequest_HoldValueIntent {
	if x, ok := x.GetIntent().(*ProvisionUUEKFromLinkRequest_HoldValue); ok {
		return x.HoldValue
	}
	return nil
}

func (x *ProvisionUUEKFromLinkRequest) GetCreateRecurringPayment() *ProvisionUUEKFromLinkRequest_CreateRecurringPaymentIntent {
	if x, ok := x.GetIntent().(*ProvisionUUEKFromLinkRequest_CreateRecurringPayment); ok {
		return x.CreateRecurringPayment
	}
	return nil
}

type isProvisionUUEKFromLinkRequest_Intent interface {
	isProvisionUUEKFromLinkRequest_Intent()
}

type ProvisionUUEKFromLinkRequest_ObtainValue struct {
	// Provision UUEK to obtain value from this linked instrument
	ObtainValue *ProvisionUUEKFromLinkRequest_ObtainValueIntent `protobuf:"bytes,2,opt,name=obtain_value,json=obtainValue,proto3,oneof"`
}

type ProvisionUUEKFromLinkRequest_ReturnValue struct {
	// Provision a UUEK to return value to this linked instrument
	ReturnValue *ProvisionUUEKFromLinkRequest_ReturnValueIntent `protobuf:"bytes,3,opt,name=return_value,json=returnValue,proto3,oneof"`
}

type ProvisionUUEKFromLinkRequest_HoldValue struct {
	// Provision a UUEK to hold value against this linked instrument
	HoldValue *ProvisionUUEKFromLinkRequest_HoldValueIntent `protobuf:"bytes,4,opt,name=hold_value,json=holdValue,proto3,oneof"`
}

type ProvisionUUEKFromLinkRequest_CreateRecurringPayment struct {
	// Provision a UUEK to authorize the creation of a recurring payment
	CreateRecurringPayment *ProvisionUUEKFromLinkRequest_CreateRecurringPaymentIntent `protobuf:"bytes,5,opt,name=create_recurring_payment,json=createRecurringPayment,proto3,oneof"`
}

func (*ProvisionUUEKFromLinkRequest_ObtainValue) isProvisionUUEKFromLinkRequest_Intent() {}

func (*ProvisionUUEKFromLinkRequest_ReturnValue) isProvisionUUEKFromLinkRequest_Intent() {}

func (*ProvisionUUEKFromLinkRequest_HoldValue) isProvisionUUEKFromLinkRequest_Intent() {}

func (*ProvisionUUEKFromLinkRequest_CreateRecurringPayment) isProvisionUUEKFromLinkRequest_Intent() {}
...
func (x *ProvisionUUEKFromLinkResponse) GetUuek() string {
	if x != nil {
		return x.Uuek
	}
	return ""
...
type ProvisionUUEKFromLinkRequest_ObtainValueIntent struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ProvisionUUEKFromLinkRequest_ObtainValueIntent) Reset() {
	*x = ProvisionUUEKFromLinkRequest_ObtainValueIntent{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProvisionUUEKFromLinkRequest_ObtainValueIntent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProvisionUUEKFromLinkRequest_ObtainValueIntent) ProtoMessage() {}

func (x *ProvisionUUEKFromLinkRequest_ObtainValueIntent) ProtoReflect() protoreflect.Message {
	mi := &file_mica_partner_instrument_v1_instrument_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProvisionUUEKFromLinkRequest_ObtainValueIntent.ProtoReflect.Descriptor instead.
func (*ProvisionUUEKFromLinkRequest_ObtainValueIntent) Descriptor() ([]byte, []int) {
	return file_mica_partner_instrument_v1_instrument_proto_rawDescGZIP(), []int{0, 0}
}

type ProvisionUUEKFromLinkRequest_ReturnValueIntent struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ProvisionUUEKFromLinkRequest_ReturnValueIntent) Reset() {
	*x = ProvisionUUEKFromLinkRequest_ReturnValueIntent{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProvisionUUEKFromLinkRequest_ReturnValueIntent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProvisionUUEKFromLinkRequest_ReturnValueIntent) ProtoMessage() {}

func (x *ProvisionUUEKFromLinkRequest_ReturnValueIntent) ProtoReflect() protoreflect.Message {
	mi := &file_mica_partner_instrument_v1_instrument_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProvisionUUEKFromLinkRequest_ReturnValueIntent.ProtoReflect.Descriptor instead.
func (*ProvisionUUEKFromLinkRequest_ReturnValueIntent) Descriptor() ([]byte, []int) {
	return file_mica_partner_instrument_v1_instrument_proto_rawDescGZIP(), []int{0, 1}
}

type ProvisionUUEKFromLinkRequest_HoldValueIntent struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ProvisionUUEKFromLinkRequest_HoldValueIntent) Reset() {
	*x = ProvisionUUEKFromLinkRequest_HoldValueIntent{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProvisionUUEKFromLinkRequest_HoldValueIntent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProvisionUUEKFromLinkRequest_HoldValueIntent) ProtoMessage() {}

func (x *ProvisionUUEKFromLinkRequest_HoldValueIntent) ProtoReflect() protoreflect.Message {
	mi := &file_mica_partner_instrument_v1_instrument_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProvisionUUEKFromLinkRequest_HoldValueIntent.ProtoReflect.Descriptor instead.
func (*ProvisionUUEKFromLinkRequest_HoldValueIntent) Descriptor() ([]byte, []int) {
	return file_mica_partner_instrument_v1_instrument_proto_rawDescGZIP(), []int{0, 2}
}

type ProvisionUUEKFromLinkRequest_CreateRecurringPaymentIntent struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ProvisionUUEKFromLinkRequest_CreateRecurringPaymentIntent) Reset() {
	*x = ProvisionUUEKFromLinkRequest_CreateRecurringPaymentIntent{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProvisionUUEKFromLinkRequest_CreateRecurringPaymentIntent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProvisionUUEKFromLinkRequest_CreateRecurringPaymentIntent) ProtoMessage() {}

func (x *ProvisionUUEKFromLinkRequest_CreateRecurringPaymentIntent) ProtoReflect() protoreflect.Message {
	mi := &file_mica_partner_instrument_v1_instrument_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProvisionUUEKFromLinkRequest_CreateRecurringPaymentIntent.ProtoReflect.Descriptor instead.
func (*ProvisionUUEKFromLinkRequest_CreateRecurringPaymentIntent) Descriptor() ([]byte, []int) {
	return file_mica_partner_instrument_v1_instrument_proto_rawDescGZIP(), []int{0, 3}
}
...
var file_mica_partner_instrument_v1_instrument_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x6f, 0x72, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x75, 0x75, 0x65,
	0x6b, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x75, 0x75, 0x65, 0x6b, 0x22, 0x75, 0x0a,
	...
	0x4e, 0x4b, 0x10, 0x04, 0x22, 0xeb, 0x01, 0x0a, 0x1e, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74,
	...
	0x69, 0x6e, 0x6b, 0x69, 0x6e, 0x67, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x34, 0x0a, 0x10, 0x6f, 0x72,
	0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x02,
	...
	0x69, 0x6f, 0x6e, 0x52, 0x65, 0x66, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x5f, 0x75, 0x75, 0x65, 0x6b, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x63, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x55, 0x75, 0x65, 0x6b, 0x42, 0x19, 0x0a, 0x17, 0x6f, 0x72, 0x67, 0x61, 0x6e,
	0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69,
	0x65, 0x72, 0x22, 0xd0, 0x04, 0x0a, 0x1f, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x4c,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x42, 0x2e, 0x6d, 0x69, 0x63, 0x61, 0x2e, 0x70, 0x61,
	...
	0x69, 0x6e, 0x67, 0x57, 0x69, 0x74, 0x68, 0x43, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	,
	...
	0x61, 0x69, 0x6d, 0x73, 0x22, 0xae, 0x01, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12,
	...
	0x54, 0x57, 0x4f, 0x52, 0x4b, 0x10, 0x02, 0x12, 0x1f, 0x0a, 0x1b, 0x53, 0x54, 0x41, 0x54, 0x55,
	0x53, 0x5f, 0x49, 0x4e, 0x56, 0x41, 0x4c, 0x49, 0x44, 0x5f, 0x4f, 0x52, 0x47, 0x41, 0x4e, 0x49,
	0x5a, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x03, 0x12, 0x22, 0x0a, 0x1e, 0x53, 0x54, 0x41, 0x54,
	0x55, 0x53, 0x5f, 0x55, 0x4e, 0x53, 0x55, 0x50, 0x50, 0x4f, 0x52, 0x54, 0x45, 0x44, 0x5f, 0x4c,
	0x49, 0x4e, 0x4b, 0x5f, 0x53, 0x4f, 0x55, 0x52, 0x43, 0x45, 0x10, 0x04, 0x12, 0x17, 0x0a, 0x13,
	0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x49, 0x4e, 0x56, 0x41, 0x4c, 0x49, 0x44, 0x5f, 0x43,
	0x4f, 0x44, 0x45, 0x10, 0x05, 0x22, 0x2b, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x4c, 0x69, 0x6e, 0x6b,
	...
	,
	...
	0x2e, 0x4c, 0x69, 0x6e, 0x6b, 0x52, 0x04, 0x6c, 0x69, 0x6e, 0x6b, 0x22, 0x4f, 0x0a, 0x06, 0x53,
	...
	,
	...
	0x63, 0x63, 0x65, 0x73, 0x73, 0x12, 0x5c, 0x0a, 0x07, 0x66, 0x61, 0x69, 0x6c, 0x75, 0x72, 0x65,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x40, 0x2e, 0x6d, 0x69, 0x63, 0x61, 0x2e, 0x70, 0x61,
	0x72, 0x74, 0x6e, 0x65, 0x72, 0x2e, 0x69, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x6d, 0x65, 0x6e, 0x74,
	...
	0x75, 0x72, 0x65, 0x1a, 0x09, 0x0a, 0x07, 0x53, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x1a, 0x7d,
	0x0a, 0x07, 0x46, 0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x12, 0x58, 0x0a, 0x04, 0x63, 0x6f, 0x64,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x44, 0x2e, 0x6d, 0x69, 0x63, 0x61, 0x2e, 0x70,
	...
	,
	...
	0x74, 0x61, 0x52, 0x0e, 0x69, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x44, 0x61,
	0x74, 0x61, 0x42, 0x52, 0x0a, 0x1d, 0x69, 0x6f, 0x2e, 0x6d, 0x69, 0x63, 0x61, 0x2e, 0x70, 0x61,
	0x72, 0x74, 0x6e, 0x65, 0x72, 0x2e, 0x69, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x6d, 0x65, 0x6e, 0x74,
	0x2e, 0x76, 0x31, 0x42, 0x0f, 0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x50,
	0x72, 0x6f, 0x74, 0x6f, 0x5a, 0x19, 0x6d, 0x69, 0x63, 0x61, 0x2f, 0x70, 0x61, 0x72, 0x74, 0x6e,
...
var file_mica_partner_instrument_v1_instrument_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_mica_partner_instrument_v1_instrument_proto_goTypes = []interface{}{
	...
	(*ProvisionUUEKFromLinkRequest_ObtainValueIntent)(nil),            // 13: mica.partner.instrument.v1.ProvisionUUEKFromLinkRequest.ObtainValueIntent
	(*ProvisionUUEKFromLinkRequest_ReturnValueIntent)(nil),            // 14: mica.partner.instrument.v1.ProvisionUUEKFromLinkRequest.ReturnValueIntent
	(*ProvisionUUEKFromLinkRequest_HoldValueIntent)(nil),              // 15: mica.partner.instrument.v1.ProvisionUUEKFromLinkRequest.HoldValueIntent
	(*ProvisionUUEKFromLinkRequest_CreateRecurringPaymentIntent)(nil), // 16: mica.partner.instrument.v1.ProvisionUUEKFromLinkRequest.CreateRecurringPaymentIntent
	(*RemoveInstrumentLinkResponse_Success)(nil),                      // 17: mica.partner.instrument.v1.RemoveInstrumentLinkResponse.Success
	(*RemoveInstrumentLinkResponse_Failure)(nil),                      // 18: mica.partner.instrument.v1.RemoveInstrumentLinkResponse.Failure
	(*v1.Error)(nil),                                                  // 19: micashared.common.v1.Error
	(*v1.LinkedInstrumentData)(nil),                                   // 20: micashared.common.v1.LinkedInstrumentData
	(*v1.InstrumentLinkClaims)(nil),                                   // 21: micashared.common.v1.InstrumentLinkClaims
}
var file_mica_partner_instrument_v1_instrument_proto_depIdxs = []int32{
	13, // 0: mica.partner.instrument.v1.ProvisionUUEKFromLinkRequest.obtain_value:type_name -> mica.partner.instrument.v1.ProvisionUUEKFromLinkRequest.ObtainValueIntent
	14, // 1: mica.partner.instrument.v1.ProvisionUUEKFromLinkRequest.return_value:type_name -> mica.partner.instrument.v1.ProvisionUUEKFromLinkRequest.ReturnValueIntent
	15, // 2: mica.partner.instrument.v1.ProvisionUUEKFromLinkRequest.hold_value:type_name -> mica.partner.instrument.v1.ProvisionUUEKFromLinkRequest.HoldValueIntent
	16, // 3: mica.partner.instrument.v1.ProvisionUUEKFromLinkRequest.create_recurring_payment:type_name -> mica.partner.instrument.v1.ProvisionUUEKFromLinkRequest.CreateRecurringPaymentIntent
	0,  // 4: mica.partner.instrument.v1.ProvisionUUEKFromLinkResponse.status:type_name -> mica.partner.instrument.v1.ProvisionUUEKFromLinkResponse.Status
	19, // 5: mica.partner.instrument.v1.ProvisionUUEKFromLinkResponse.error:type_name -> micashared.common.v1.Error
	1,  // 6: mica.partner.instrument.v1.CompleteLinkingWithCodeResponse.status:type_name -> mica.partner.instrument.v1.CompleteLinkingWithCodeResponse.Status
	19, // 7: mica.partner.instrument.v1.CompleteLinkingWithCodeResponse.error:type_name -> micashared.common.v1.Error
	20, // 8: mica.partner.instrument.v1.CompleteLinkingWithCodeResponse.instrument_data:type_name -> micashared.common.v1.LinkedInstrumentData
	21, // 9: mica.partner.instrument.v1.CompleteLinkingWithCodeResponse.claims:type_name -> micashared.common.v1.InstrumentLinkClaims
	2,  // 10: mica.partner.instrument.v1.GetLinkResponse.status:type_name -> mica.partner.instrument.v1.GetLinkResponse.Status
	19, // 11: mica.partner.instrument.v1.GetLinkResponse.error:type_name -> micashared.common.v1.Error
	12, // 12: mica.partner.instrument.v1.GetLinkResponse.link:type_name -> mica.partner.instrument.v1.Link
	17, // 13: mica.partner.instrument.v1.RemoveInstrumentLinkResponse.success:type_name -> mica.partner.instrument.v1.RemoveInstrumentLinkResponse.Success
	18, // 14: mica.partner.instrument.v1.RemoveInstrumentLinkResponse.failure:type_name -> mica.partner.instrument.v1.RemoveInstrumentLinkResponse.Failure
	20, // 15: mica.partner.instrument.v1.Link.instrument_data:type_name -> micashared.common.v1.LinkedInstrumentData
	3,  // 16: mica.partner.instrument.v1.RemoveInstrumentLinkResponse.Failure.code:type_name -> mica.partner.instrument.v1.RemoveInstrumentLinkResponse.FailureCode
...
func file_mica_partner_instrument_v1_instrument_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_mica_partner_instrument_v1_instrument_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProvisionUUEKFromLinkRequest_ObtainValueIntent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mica_partner_instrument_v1_instrument_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProvisionUUEKFromLinkRequest_ReturnValueIntent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mica_partner_instrument_v1_instrument_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProvisionUUEKFromLinkRequest_HoldValueIntent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mica_partner_instrument_v1_instrument_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProvisionUUEKFromLinkRequest_CreateRecurringPaymentIntent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_mica_partner_instrument_v1_instrument_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*ProvisionUUEKFromLinkRequest_ObtainValue)(nil),
		(*ProvisionUUEKFromLinkRequest_ReturnValue)(nil),
		(*ProvisionUUEKFromLinkRequest_HoldValue)(nil),
		(*ProvisionUUEKFromLinkRequest_CreateRecurringPayment)(nil),
	}
