...
const (
	...
	ServiceProviderToMicaService_ProvisionServiceProviderPaymentToken_FullMethodName = "/mica.serviceprovider.service.v1.ServiceProviderToMicaService/ProvisionServiceProviderPaymentToken"
	ServiceProviderToMicaService_RemoveServiceProviderPaymentToken_FullMethodName    = "/mica.serviceprovider.service.v1.ServiceProviderToMicaService/RemoveServiceProviderPaymentToken"
	ServiceProviderToMicaService_SearchServiceProviderPaymentToken_FullMethodName    = "/mica.serviceprovider.service.v1.ServiceProviderToMicaService/SearchServiceProviderPaymentToken"
...
func (c *serviceProviderToMicaServiceClient) ResetPIN(ctx context.Context, in *instrumentv1.ResetPINRequest, opts ...grpc.CallOption) (*instrumentv1.ResetPINResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServiceProviderToMicaService_ResetPIN_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceProviderToMicaServiceClient) RemovePIN(ctx context.Context, in *instrumentv1.RemovePINRequest, opts ...grpc.CallOption) (*instrumentv1.RemovePINResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServiceProviderToMicaService_RemovePIN_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceProviderToMicaServiceClient) ProvisionServiceProviderPaymentToken(ctx context.Context, in *paymenttokenv1.ProvisionServiceProviderPaymentTokenRequest, opts ...grpc.CallOption) (*paymenttokenv1.ProvisionServiceProviderPaymentTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServiceProviderToMicaService_ProvisionServiceProviderPaymentToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceProviderToMicaServiceClient) RemoveServiceProviderPaymentToken(ctx context.Context, in *paymenttokenv1.RemoveServiceProviderPaymentTokenRequest, opts ...grpc.CallOption) (*paymenttokenv1.RemoveServiceProviderPaymentTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServiceProviderToMicaService_RemoveServiceProviderPaymentToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceProviderToMicaServiceClient) SearchServiceProviderPaymentToken(ctx context.Context, in *paymenttokenv1.SearchServiceProviderPaymentTokenRequest, opts ...grpc.CallOption) (*paymenttokenv1.SearchServiceProviderPaymentTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServiceProviderToMicaService_SearchServiceProviderPaymentToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceProviderToMicaServiceClient) SearchValue(ctx context.Context, in *valuev1.SearchValueRequest, opts ...grpc.CallOption) (*valuev1.SearchValueResponse, error) {
	out := new(valuev1.SearchValueResponse)
	err := c.cc.Invoke(ctx, ServiceProviderToMicaService_SearchValue_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedServiceProviderToMicaServiceServer) SearchValue(context.Context, *valuev1.SearchValueRequest) (*valuev1.SearchValueResponse, error) {
...
func _ServiceProviderToMicaService_SetPIN_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ServiceProviderToMicaService_SetPIN_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ServiceProviderToMicaService_ResetPIN_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ServiceProviderToMicaService_ResetPIN_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ServiceProviderToMicaService_RemovePIN_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ServiceProviderToMicaService_RemovePIN_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ServiceProviderToMicaService_ProvisionServiceProviderPaymentToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ServiceProviderToMicaService_ProvisionServiceProviderPaymentToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ServiceProviderToMicaService_RemoveServiceProviderPaymentToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ServiceProviderToMicaService_RemoveServiceProviderPaymentToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ServiceProviderToMicaService_SearchServiceProviderPaymentToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ServiceProviderToMicaService_SearchServiceProviderPaymentToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ServiceProviderToMicaService_SearchValue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(valuev1.SearchValueRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceProviderToMicaServiceServer).SearchValue(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ServiceProviderToMicaService_SearchValue_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceProviderToMicaServiceServer).SearchValue(ctx, req.(*valuev1.SearchValueRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ServiceProviderToMicaService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ServiceProviderToMicaService_SearchValue_Handler,
		},
		{
			MethodName: "GetValue",
