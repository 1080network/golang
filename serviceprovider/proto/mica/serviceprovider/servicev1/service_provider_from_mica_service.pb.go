...
var file_mica_serviceprovider_service_v1_service_provider_from_mica_service_proto_rawDesc = []byte{
	...
	0x70, 0x69, 0x6e, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x95, 0x08, 0x0a, 0x1e, 0x53,
...
var file_mica_serviceprovider_service_v1_service_provider_from_mica_service_proto_goTypes = []interface{}{
	...
	(*valuev1.ReceiveValueRequest)(nil),              // 5: mica.serviceprovider.value.v1.ReceiveValueRequest
	(*pingv1.PingRequest)(nil),                       // 6: micashared.common.ping.v1.PingRequest
	(*userv1.EnrollUserInstrumentResponse)(nil),      // 7: mica.serviceprovider.user.v1.EnrollUserInstrumentResponse
	(*instrumentv1.RetrieveTransactionResponse)(nil), // 8: mica.serviceprovider.instrument.v1.RetrieveTransactionResponse
	(*valuev1.ObtainValueResponse)(nil),              // 9: mica.serviceprovider.value.v1.ObtainValueResponse
	(*valuev1.ReverseValueResponse)(nil),             // 10: mica.serviceprovider.value.v1.ReverseValueResponse
	(*valuev1.ReturnValueResponse)(nil),              // 11: mica.serviceprovider.value.v1.ReturnValueResponse
	(*valuev1.ReceiveValueResponse)(nil),             // 12: mica.serviceprovider.value.v1.ReceiveValueResponse
...
var file_mica_serviceprovider_service_v1_service_provider_from_mica_service_proto_depIdxs = []int32{
	...
	5,  // 6: mica.serviceprovider.service.v1.ServiceProviderFromMicaService.ReceiveValue:input_type -> mica.serviceprovider.value.v1.ReceiveValueRequest
	6,  // 7: mica.serviceprovider.service.v1.ServiceProviderFromMicaService.Ping:input_type -> micashared.common.ping.v1.PingRequest
	7,  // 8: mica.serviceprovider.service.v1.ServiceProviderFromMicaService.EnrollUserInstrument:output_type -> mica.serviceprovider.user.v1.EnrollUserInstrumentResponse
	8,  // 9: mica.serviceprovider.service.v1.ServiceProviderFromMicaService.RetrieveTransaction:output_type -> mica.serviceprovider.instrument.v1.RetrieveTransactionResponse
	9,  // 10: mica.serviceprovider.service.v1.ServiceProviderFromMicaService.ObtainValue:output_type -> mica.serviceprovider.value.v1.ObtainValueResponse
	10, // 11: mica.serviceprovider.service.v1.ServiceProviderFromMicaService.ReverseObtainValue:output_type -> mica.serviceprovider.value.v1.ReverseValueResponse
	11, // 12: mica.serviceprovider.service.v1.ServiceProviderFromMicaService.ReturnValue:output_type -> mica.serviceprovider.value.v1.ReturnValueResponse
	10, // 13: mica.serviceprovider.service.v1.ServiceProviderFromMicaService.ReverseReturnValue:output_type -> mica.serviceprovider.value.v1.ReverseValueResponse
	12, // 14: mica.serviceprovider.service.v1.ServiceProviderFromMicaService.ReceiveValue:output_type -> mica.serviceprovider.value.v1.ReceiveValueResponse
	13, // 15: mica.serviceprovider.service.v1.ServiceProviderFromMicaService.Ping:output_type -> micashared.common.ping.v1.PingResponse
