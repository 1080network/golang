...
func (c *serviceProviderToMicaServiceClient) SearchValue(ctx context.Context, in *valuev1.SearchValueRequest, opts ...grpc.CallOption) (*valuev1.SearchValueResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/serviceprovider.service.v1.ServiceProviderToMicaService/SearchValue", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceProviderToMicaServiceClient) GetValue(ctx context.Context, in *valuev1.GetValueRequest, opts ...grpc.CallOption) (*valuev1.GetValueResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/serviceprovider.service.v1.ServiceProviderToMicaService/GetValue", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ServiceProviderToMicaService_SearchValue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/serviceprovider.service.v1.ServiceProviderToMicaService/SearchValue",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ServiceProviderToMicaService_GetValue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/serviceprovider.service.v1.ServiceProviderToMicaService/GetValue",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
