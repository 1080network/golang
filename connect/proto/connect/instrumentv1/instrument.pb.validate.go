...
func (m *WidgetRegisterInstrumentInitiateRequest) validate(all bool) error {
	...
	case *WidgetRegisterInstrumentInitiateRequest_BankAccountCredentials:

		if all {
			switch v := interface{}(m.GetBankAccountCredentials()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, WidgetRegisterInstrumentInitiateRequestValidationError{
						field:  "BankAccountCredentials",
		...
		} else if v, ok := interface{}(m.GetBankAccountCredentials()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
	...
	case *WidgetRegisterInstrumentInitiateRequest_BankAccountNumber:

		if all {
			switch v := interface{}(m.GetBankAccountNumber()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, WidgetRegisterInstrumentInitiateRequestValidationError{
		...
		} else if v, ok := interface{}(m.GetBankAccountNumber()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return WidgetRegisterInstrumentInitiateRequestValidationError{
					field:  "BankAccountNumber",
					reason: "embedded message failed validation",
...
func (m *WidgetRegisterInstrumentCompleteRequest) validate(all bool) error {
	...
	case *WidgetRegisterInstrumentCompleteRequest_Ribbit:

		if all {
			switch v := interface{}(m.GetRibbit()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, WidgetRegisterInstrumentCompleteRequestValidationError{
						field:  "Ribbit",
		...
		} else if v, ok := interface{}(m.GetRibbit()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return WidgetRegisterInstrumentCompleteRequestValidationError{
					field:  "Ribbit",
					reason: "embedded message failed validation",
...
// Validate checks the field values on Ribbit with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *Ribbit) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on Ribbit with the rules defined in the
// proto definition for this message. If any rules are violated, the result is
// a list of violation errors wrapped in RibbitMultiError, or nil if none found.
func (m *Ribbit) ValidateAll() error {
	return m.validate(true)
}

func (m *Ribbit) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return RibbitMultiError(errors)
	}

	return nil
}

// RibbitMultiError is an error wrapping multiple validation errors returned by
// Ribbit.ValidateAll() if the designated constraints aren't met.
type RibbitMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m RibbitMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m RibbitMultiError) AllErrors() []error { return m }

// RibbitValidationError is the validation error returned by Ribbit.Validate if
// the designated constraints aren't met.
type RibbitValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e RibbitValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e RibbitValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e RibbitValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e RibbitValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e RibbitValidationError) ErrorName() string { return "RibbitValidationError" }

// Error satisfies the builtin error interface
func (e RibbitValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = RibbitValidationError{}
...
// Validate checks the field values on
// WidgetRibbitRegisterInstrumentInitiateRequest with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *WidgetRibbitRegisterInstrumentInitiateRequest) Validate() error {
	return m.validate(false)
}
...
// proto definition for this message. If any rules are violated, the result is
// a list of violation errors wrapped in
// WidgetRibbitRegisterInstrumentInitiateRequestMultiError, or nil if none found.
func (m *WidgetRibbitRegisterInstrumentInitiateRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *WidgetRibbitRegisterInstrumentInitiateRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
...
// WidgetRibbitRegisterInstrumentInitiateRequestMultiError is an error wrapping
// multiple validation errors returned by
// WidgetRibbitRegisterInstrumentInitiateRequest.ValidateAll() if the
// designated constraints aren't met.
type WidgetRibbitRegisterInstrumentInitiateRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m WidgetRibbitRegisterInstrumentInitiateRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m WidgetRibbitRegisterInstrumentInitiateRequestMultiError) AllErrors() []error { return m }

// WidgetRibbitRegisterInstrumentInitiateRequestValidationError is the
// validation error returned by
// WidgetRibbitRegisterInstrumentInitiateRequest.Validate if the designated
// constraints aren't met.
type WidgetRibbitRegisterInstrumentInitiateRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e WidgetRibbitRegisterInstrumentInitiateRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e WidgetRibbitRegisterInstrumentInitiateRequestValidationError) Reason() string {
	return e.reason
}

// Cause function returns cause value.
func (e WidgetRibbitRegisterInstrumentInitiateRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e WidgetRibbitRegisterInstrumentInitiateRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e WidgetRibbitRegisterInstrumentInitiateRequestValidationError) ErrorName() string {
	return "WidgetRibbitRegisterInstrumentInitiateRequestValidationError"
}

// Error satisfies the builtin error interface
func (e WidgetRibbitRegisterInstrumentInitiateRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sWidgetRibbitRegisterInstrumentInitiateRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = WidgetRibbitRegisterInstrumentInitiateRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = WidgetRibbitRegisterInstrumentInitiateRequestValidationError{}

// Validate checks the field values on
// WidgetRibbitRegisterInstrumentInitiateResponse with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *WidgetRibbitRegisterInstrumentInitiateResponse) Validate() error {
	return m.validate(false)
}
...
// WidgetRibbitRegisterInstrumentInitiateResponseMultiError, or nil if none found.
func (m *WidgetRibbitRegisterInstrumentInitiateResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *WidgetRibbitRegisterInstrumentInitiateResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, WidgetRibbitRegisterInstrumentInitiateResponseValidationError{
					field:  "Error",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return WidgetRibbitRegisterInstrumentInitiateResponseValidationError{
				field:  "Error",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	// no validation rules for RibbitInstitutionId

	if len(errors) > 0 {
		return WidgetRibbitRegisterInstrumentInitiateResponseMultiError(errors)
	}

	return nil
}

// WidgetRibbitRegisterInstrumentInitiateResponseMultiError is an error
// wrapping multiple validation errors returned by
// WidgetRibbitRegisterInstrumentInitiateResponse.ValidateAll() if the
// designated constraints aren't met.
type WidgetRibbitRegisterInstrumentInitiateResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m WidgetRibbitRegisterInstrumentInitiateResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m WidgetRibbitRegisterInstrumentInitiateResponseMultiError) AllErrors() []error { return m }

// WidgetRibbitRegisterInstrumentInitiateResponseValidationError is the
// validation error returned by
// WidgetRibbitRegisterInstrumentInitiateResponse.Validate if the designated
// constraints aren't met.
type WidgetRibbitRegisterInstrumentInitiateResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e WidgetRibbitRegisterInstrumentInitiateResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e WidgetRibbitRegisterInstrumentInitiateResponseValidationError) Reason() string {
	return e.reason
}

// Cause function returns cause value.
func (e WidgetRibbitRegisterInstrumentInitiateResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e WidgetRibbitRegisterInstrumentInitiateResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e WidgetRibbitRegisterInstrumentInitiateResponseValidationError) ErrorName() string {
	return "WidgetRibbitRegisterInstrumentInitiateResponseValidationError"
}

// Error satisfies the builtin error interface
func (e WidgetRibbitRegisterInstrumentInitiateResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sWidgetRibbitRegisterInstrumentInitiateResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = WidgetRibbitRegisterInstrumentInitiateResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = WidgetRibbitRegisterInstrumentInitiateResponseValidationError{}
