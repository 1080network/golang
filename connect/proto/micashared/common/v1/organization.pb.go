...
type LegacyConfiguration struct {
	...
	InterchangePercentage *wrappers.StringValue `protobuf:"bytes,1,opt,name=interchange_percentage,json=interchangePercentage,proto3" json:"interchange_percentage,omitempty"`
	DisputeRatePercentage *wrappers.StringValue `protobuf:"bytes,2,opt,name=dispute_rate_percentage,json=disputeRatePercentage,proto3" json:"dispute_rate_percentage,omitempty"`
	...
	DisputeFee            *wrappers.StringValue `protobuf:"bytes,4,opt,name=dispute_fee,json=disputeFee,proto3" json:"dispute_fee,omitempty"`
	DisputeManagementCost *wrappers.StringValue `protobuf:"bytes,5,opt,name=dispute_management_cost,json=disputeManagementCost,proto3" json:"dispute_management_cost,omitempty"`
	NetworkMembershipFee  *wrappers.StringValue `protobuf:"bytes,6,opt,name=network_membership_fee,json=networkMembershipFee,proto3" json:"network_membership_fee,omitempty"`
	NetworkTransactionFee *wrappers.StringValue `protobuf:"bytes,7,opt,name=network_transaction_fee,json=networkTransactionFee,proto3" json:"network_transaction_fee,omitempty"`
	NetworkReportingFee   *wrappers.StringValue `protobuf:"bytes,8,opt,name=network_reporting_fee,json=networkReportingFee,proto3" json:"network_reporting_fee,omitempty"`
}
...
func (x *LegacyConfiguration) GetInterchangePercentage() *wrappers.StringValue {
	if x != nil {
...
func (x *LegacyConfiguration) GetDisputeRatePercentage() *wrappers.StringValue {
	if x != nil {
...
func (x *LegacyConfiguration) GetDisputeFee() *wrappers.StringValue {
	if x != nil {
		return x.DisputeFee
	}
	return nil
...
func (x *LegacyConfiguration) GetDisputeManagementCost() *wrappers.StringValue {
	if x != nil {
...
func (x *LegacyConfiguration) GetNetworkMembershipFee() *wrappers.StringValue {
	if x != nil {
...
func (x *LegacyConfiguration) GetNetworkTransactionFee() *wrappers.StringValue {
	if x != nil {
...
func (x *LegacyConfiguration) GetNetworkReportingFee() *wrappers.StringValue {
	if x != nil {
